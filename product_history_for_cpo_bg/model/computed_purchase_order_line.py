...
class ComputedPurchaseOrderLine(models.Model):
    ...
    # Columns section
    displayed_product_history_ids = fields.Many2many(comodel_name='product.history', 
        relation='displayed_product_history', column1='product_id', column2='product_history_ids', 
    ...
    def view_history(self):
        model, action_id = self.pool[
            ...
            self._cr, self._uid, 'product_history_for_cpo_bg',
            "action_view_history")
