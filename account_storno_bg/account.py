...
class account_move_line(osv.Model):
    ...
    def _check_contra_minus(self, cr, uid, ids, context=None):
        ...
        for l in self.browse(cr, uid, ids, context=context):
            if l.journal_id.type in ('sale', 'sale_refund', 'purchase', 'purchase_refund') and l.journal_id.posting_policy == 'contra':
    ...
    def _amount_residual(self, cr, uid, ids, field_names, args, context=None):
        ...
        #_logger.info("Residual %s:%s" % (res, move_line.journal_id))
        return res
