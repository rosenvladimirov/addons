...
class AccountAssetModify(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        if 'method_percentage' in fields_list and \
                asset.method_time == 'percentage':
            res.update({'method_percentage': asset.method_percentage})
    ...
    def modify(self):
        ...
        if self.method_percentage != asset.method_percentage:
            asset_vals['method_percentage'] = self.method_percentage
