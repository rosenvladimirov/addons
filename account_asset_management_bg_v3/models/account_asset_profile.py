...
class AccountAssetProfile(models.Model):
    ...
    def _get_type_ctx(self):
        return self._context.get('mode', 'normal')
    ...
    method_number = fields.Integer(
        string='Number of Years/Month',
        help="The number of years/month needed to depreciate your asset",
        default=5)
    ...
    type = fields.Selection(
        selection=[('normal', 'For accounting '),
                  ('taxadmin', 'From Tax administration')
                  ],
        string='Type of profile',
        default=_get_type_ctx,
        readonly=True,
        help="Choice the type of profile "
             "for accounting depreciation or\n"
             "defined by tax law depreciation percent\n.")
