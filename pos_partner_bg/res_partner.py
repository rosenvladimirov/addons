...
class res_partner(models.Model):
    ...
    pos_order_sum = fields.Float(compute='_pos_order_sum', string='Sum', digits=dp.get_precision('Account'))
    ...
    def create(self, vals):
        ...
        if pos_customer:
            partner.write({'category_id': [(6, 0 , [self.env.ref('pos_partner_bg.categ_pos_customer').id])]})
        return partner
