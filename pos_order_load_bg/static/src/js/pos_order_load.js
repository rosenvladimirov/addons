...
openerp.pos_order_load_bg = function(instance, local) {
    ...
    */
    module.PosWidget = module.PosWidget.extend({
        build_widgets: function() {
            ...
            // Add buttons beffore say remove hidden class on control-button
            this.pos_widget.$('.control-buttons').removeClass('oe_hidden');
            this.load_button = new module.LoadButtonWidget(this,{});
            this.load_button.appendTo(this.pos_widget.$('.control-buttons'));
            this.pos_widget.$('.load-button').removeClass('oe_hidden');

            this.save_button = new module.SaveButtonWidget(this,{});
            this.save_button.appendTo(this.pos_widget.$('.control-buttons'));
            this.pos_widget.$('.save-button').addClass('oe_hidden');
            console.log("Load buttons", this.load_button);
        },
    });
    ...
    */
    module.OrderWidget = module.OrderWidget.extend({
        renderElement: function(scrollbottom){
            ...
            if (this.pos_widget.load_button  && (this.pos.get('selectedOrder').get('orderLines').length === 0)) {
