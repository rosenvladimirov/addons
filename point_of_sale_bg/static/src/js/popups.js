...
function openerp_pos_popups(instance, module){ //module is instance.point_of_sale_bg
    ...
    module.ErrorPopupWidget = module.PopUpWidget.extend({
        ...
        show: function(options){
            ...
            $('body').append('<audio src="/point_of_sale_bg/static/src/sounds/error.wav" autoplay="true"></audio>');
