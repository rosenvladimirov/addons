...
function openerp_pos_screens(instance, module){ //module is instance.point_of_sale_bg
    ...
    module.ScaleScreenWidget = module.ScreenWidget.extend({
        ...
        order_product: function(){
            ...
            selectOrder.addProduct(this.get_product(), {price: this.pos.pricelist_engine.update_products_prices(this.get_product(), selectOrder.get_client()).price, quantity: this.weight });
        },
            ...
            this.product_list_widget = new module.ProductListWidget(this,{
                click_product_action: function(product){
                    if(product.to_weight && self.pos.config.iface_electronic_scale){
                        ...
                        selectOrder.addProduct(product, self.pos.pricelist_engine.update_products_prices(product, selectOrder.get_client()));
                    }
                },
    ...
    module.ReceiptScreenWidget = module.ScreenWidget.extend({
        ...
        show: function(){
            ...
            var print_button = this.add_action_button({
                    label: _t('Print'),
                    icon: '/point_of_sale_bg/static/src/img/icons/png48/printer.png',
                    click: function(){ self.print(); },
                });

            var finish_button = this.add_action_button({
                    label: _t('Next Order'),
                    icon: '/point_of_sale_bg/static/src/img/icons/png48/go-next.png',
    ...
    module.PaymentScreenWidget = module.ScreenWidget.extend({
        ...
        show: function(){
            ...
            this.add_action_button({
                    label: _t('Back'),
                    icon: '/point_of_sale_bg/static/src/img/icons/png48/go-previous.png',
                    click: function(){  
                        self.back();
                    },
                });
            ...
            this.add_action_button({
                    label: _t('Validate'),
                    name: 'validation',
                    icon: '/point_of_sale_bg/static/src/img/icons/png48/validate.png',
                    click: function(){
                        self.validate_order();
                    },
                });
            ...
            if( this.pos.config.iface_invoicing ){
                this.add_action_button({
                        label: _t('Invoice'),
                        name: 'invoice',
                        icon: '/point_of_sale_bg/static/src/img/icons/png48/invoice.png',
                        click: function(){
            ...
            if( this.pos.config.iface_cashdrawer ){
                this.add_action_button({
                        label: _t('Cash'),
                        name: 'cashbox',
                        icon: '/point_of_sale_bg/static/src/img/open-cashbox.png',
                        click: function(){
