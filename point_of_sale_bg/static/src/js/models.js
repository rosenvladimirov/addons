function openerp_pos_models(instance, module){ //module is instance.point_of_sale_bg
        ...
        push_and_invoice_order: function(order){
            ...
            this.flush_mutex.exec(function(){
                ...
                transfer.pipe(function(order_server_id){
                    ...
                    self.pos_widget.do_action('point_of_sale_bg.pos_invoice_report',{additional_context:{ 
    ...
    module.Order = Backbone.Model.extend({
        ...
        findProduct(line){
            ...
            for (var i=0, len=orderLines.lenght; i<len; i++){
                if(line.get_product().id === orderLine[i].get_product().id){
                    return orderLine;
                }
            }
        },
        addProduct: function(product, options){
            ...
            if(options.fullmerge !== undefined && options.fullmerge === true ) {
    ...
    module.PricelistEngine = instance.web.Class.extend({
        ...
        update_products_prices: function(product, partner, db) {
            ...
            for (var k = 0; k < quantities.length; k++) {
                ...
                if (price !== false) {
                    var price = this.pos.taxes_engine.get_all_prices({quantity: qty, unit_price: price, disc: 0, force_tax_included: false, product: product,});
                    price = price.priceWithTax;
            ...
            return {price: price_display, tooltip: prices_tooltip};
        },
        /**
         * @param partner
         */
        update_products_ui: function(partner) {
            ...
            for (var i = 0, len = product_list_ui.length; i < len; i++) {
                ...
                if (Math.abs(product.lst_price - price.price) > 0.001){
                    ...
                    if (price.tooltip != '') {
                        price.tooltip = '(' + this.pos_widget.format_currency(product.lst_price, 'Product Price') + ')' + price.tooltip;
