function openerp_pos_widgets(instance, module){ //module is instance.point_of_sale_bg
    ...
    module.ProductListWidget = module.PosBaseWidget.extend({
        ...
        render_product: function(product, partner){
        ...
        renderElement: function() {
            ...
            for(var i = 0, len = this.product_list.length; i < len; i++){
                var product_node = this.render_product(this.product_list[i],this.pos.get('selectedOrder').get_client());
    ...
    - This widget has some part of code that come from point_of_sale_bg.ProductListWidget;
    *********************************************************** */
            ...
            return self.pos.ready.done(function() {
                if ($.browser.chrome) {
                    ...
                    if (parseInt(chrome_version, 10) >= 50) {
                        openerp.loadCSS('/point_of_sale_bg/static/src/css/chrome50.css');
                    }
                }
