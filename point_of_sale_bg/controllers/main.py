...
class PosController(http.Controller):
    ...
    def a(self, debug=False, **k):
        ...
        if not pos_session_ids:
            return werkzeug.utils.redirect('/web#action=point_of_sale_bg.action_pos_session_opening')
        ...
        html = request.registry.get('ir.ui.view').render(cr, session.uid,'point_of_sale_bg.index',{
            'modules': modules,
            'init': init,
        })
